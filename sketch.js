...
function draw() {
  background(180);
  //Agregamos la puntuacion al avansar los frames
  ...
  if(gameState === PLAY){
    ...
    //reiniciamos el suelo
    if (ground.x < 0){
    ground.x = ground.width/2;
    }
   //Hacemos que el trex salte
    ...
    //para que el trex choque al suelo
...
function spawnObstacles(){
  ...
  //generar obstaculos cada 60 frames
 if (frameCount % 60 === 0){
